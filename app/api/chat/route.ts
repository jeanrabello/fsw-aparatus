  ...
  const result = streamText({
    ...
    tools: {
      ...
      getAvailableTimeSlotsForBarbershop: tool({
        description:
          "Obtém os horários disponíveis para uma barbearia específica em uma data específica.",
        inputSchema: z.object({
          barbershopId: z.string().describe("ID da barbearia"),
          date: z.string().describe("Data em ISO String para a qual deseja obter os horários disponíveis."),
        }),
